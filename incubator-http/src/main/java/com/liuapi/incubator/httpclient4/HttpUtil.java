package com.liuapi.incubator.httpclient4;
...
public class HttpUtil {
    ...
    private static String setDefaultCharset(String mediaType) {
    ...
    private static String getParamString(List<NameValuePair> params) {
